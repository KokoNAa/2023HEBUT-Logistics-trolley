...
void USART2_IRQHandler(void)                	//串口1中断服务程序
{
	...
	{
		op1_Data =USART_ReceiveData(USART2);//(USART2->DR);	//读取接收到的数据
		USART_ClearITPendingBit(USART2,USART_IT_RXNE);  //清除RXNE标志位
//		if((USART2_RX_STA&0x8000)==0)//接收未完成
//		{
//			if(USART2_RX_STA&0x4000)//接收到了0x0d
//			{
//				if(op1_Data!=0x0a)USART2_RX_STA=0;//接收错误,重新开始
//				else USART2_RX_STA|=0x8000;	//接收完成了 
//			}
//			else //还没收到0X0D
//			{	
//				if(op1_Data==0x0d)USART2_RX_STA|=0x4000;
//				else
//				{
//					USART2_RX_BUF[USART2_RX_STA&0X3FFF]=op1_Data ;
//					USART2_RX_STA++;
